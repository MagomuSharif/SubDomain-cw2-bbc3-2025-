    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center" data-aos="zoom-out" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <h2>To Create Account</h2>
            <p>Please Enter Your Details</p>
            <form action="{{ route('register') }}" class="col-md-6 offset-md-3" method="POST">
                @csrf
                <div>
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control" placeholder="Enter user email" name="email" value="{{ old('email') }}">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="password" class="form-control" name="password_comfirmation" placeholder="confirm password">
              </div>
              <div class="pt-3">
